    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
        <form class="modal-content form form-vertical" method="POST" id="form-add">
            ...
            <div class="modal-header bg-primary">
                <h5 class="modal-title white" id="myModalLabel160">Tambah Data Posyandu</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control informasi_posyandu" name="informasi_posyandu" rows="10"></textarea>
                            </div>
                        </div>
                    </div>
                </div>

<div class="modal fade text-left" id="edit" role="dialog" aria-labelledby="myModalLabel130"
    aria-hidden="true">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group mb-3">
                                ...
                                <select name="id_ibu" id="e-id_ibu" class="form-select"></select>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group mb-3">
                            ...
                            <div class="form-group mb-3 ">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="jenis_kelamin"
                                        id="jenis_l" value="L">
                                    <label class="form-check-label" for="jenis_l">Laki - Laki</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="jenis_kelamin"
                                        id="jenis_p" value="P">
                                    <label class="form-check-label" for="jenis_p">Perempuan</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">

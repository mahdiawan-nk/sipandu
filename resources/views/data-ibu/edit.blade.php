<div class="modal fade text-left" id="edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel130"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <form class="modal-content form form-vertical" id="form-edit">
            ...
            <div class="modal-header bg-secondary">
                <h5 class="modal-title white" id="myModalLabel130">Ubah Data Ibu</h5>
                        ...
                        <div class="col-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="nik" name="nik"
                                    onkeypress="return isNumberKey(event)" oninput="validateNumberInput(this)">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group mb-3">

    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#add">Tambah Data Jenis Imunisasi</button>
            </div>
            <div class="card-body">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('form#form-edit').submit(function(e) {
                ...
                e.stopPropagation()
                let formDataArray = new FormData(this)
                const url = '{{ route('jenisimunisasi.datajenisimunisasi.update', ['datajenisimunisasi' => ':idData']) }}'.replace(':idData',
                    idData);
                const requestOptions = {
                    method: 'POST',
            ...
            $('#btn-hapus').on('click', function() {
                const url = '{{ route('jenisimunisasi.datajenisimunisasi.destroy', ['datajenisimunisasi' => ':idData']) }}'.replace(':idData',
                    idData);
                const requestOptions = {
                    method: 'DELETE',
                };
